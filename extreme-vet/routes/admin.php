...
Route::group(['prefix'=>'admin','as'=>'admin.','namespace'=>'Admin','middleware'=>'Admin'],function(){
    ...
    Route::get('owners_export','OwnersController@export')->name('owners.export'); 
    Route::get('owners_download_template','OwnersController@download_template')->name('owners.download_template'); 
    Route::post('owners_import','OwnersController@import')->name('owners.import'); 
   
    //animals
    Route::resource('animals','AnimalsController');
    Route::get('animals_export','AnimalsController@export')->name('animals.export'); 
    Route::get('animals_download_template','AnimalsController@download_template')->name('animals.download_template'); 
    Route::post('animals_import','AnimalsController@import')->name('animals.import'); 
