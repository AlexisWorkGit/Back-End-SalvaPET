...
Route::group(['prefix'=>'ajax','as'=>'ajax.'],function(){
    ...
    //get animals
    Route::get('get_animal_by_code','AjaxController@get_animal_by_code')->name('get_animal_by_code'); 
    Route::get('get_animal_by_name','AjaxController@get_animal_by_name')->name('get_animal_by_name'); 
    Route::get('get_animal_by_code_owner','AjaxController@get_animal_by_code_owner')->name('get_animal_by_code_owner'); 
    Route::get('get_animal_by_name_owner','AjaxController@get_animal_by_name_owner')->name('get_animal_by_name_owner'); 
    Route::get('get_animal','AjaxController@get_animal')->name('get_animal'); 

    //get owner
    Route::get('get_owners','AjaxController@get_owners')->name('get_owners'); 

    //create animal
    Route::post('create_animal','AjaxController@create_animal')->name('create_animal');

    //create owner
    Route::post('create_owner','AjaxController@create_owner')->name('create_owner');
