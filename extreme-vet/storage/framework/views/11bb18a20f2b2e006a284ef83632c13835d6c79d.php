      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><?php echo e(__('Edit Culture')); ?></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title"><?php echo e(__('Edit Culture')); ?></h3>
    </div>
    <!-- /.card-header -->
    <form method="POST" action="<?php echo e(route('admin.cultures.update',$culture->id)); ?>">
        <!-- /.card-header -->
        <div class="card-body">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\extreme-vet\resources\views/admin/cultures/edit.blade.php ENDPATH**/ ?>