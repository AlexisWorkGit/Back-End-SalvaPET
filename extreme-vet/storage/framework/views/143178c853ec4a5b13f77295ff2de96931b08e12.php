      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><?php echo e(__('Animal owners')); ?></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title"><?php echo e(__('Animal owners table')); ?></h3>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_owner')): ?>
      <a href="<?php echo e(route('admin.owners.create')); ?>" class="btn btn-primary btn-sm float-right">
    ...
    <div class="card-body">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12 text-center">
                      <a class="btn btn-success" href="<?php echo e(route('admin.owners.export')); ?>">
                        <i class="fa fa-file-excel"></i>
                        <?php echo e(__('Export')); ?>

                      </a>
                      <a class="btn btn-success" href="<?php echo e(route('admin.owners.download_template')); ?>">
                        <i class="fa fa-file-excel"></i>
                    ...
                    <div class="col-lg-12">
                      <!-- import form -->
                      <form action="<?php echo e(route('admin.owners.import')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row mt-3">
                          <div class="col-lg-12">
      ...
      <div class="row">
        <div class="col-lg-12 table-responsive">
          <table id="owners_table" class="table table-striped table-hover table-bordered" width="100%">
            <thead>
            <tr>
              <th width="10px">#</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/veterinaria/extreme-vet/resources/views/admin/owners/index.blade.php ENDPATH**/ ?>