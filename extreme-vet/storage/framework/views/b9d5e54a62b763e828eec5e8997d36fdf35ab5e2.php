...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title"><?php echo e(__('Edit culture option')); ?></h3>
    </div>
    <form action="<?php echo e(route('admin.culture_options.update',$option['id'])); ?>" method="POST" id="option_form">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\extreme-vet\resources\views/admin/culture_options/edit.blade.php ENDPATH**/ ?>