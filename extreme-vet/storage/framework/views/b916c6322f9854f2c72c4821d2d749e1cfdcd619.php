...
<style>
    ...
    <div class="accounting_header">
        ...
        <h5 align="center"><?php echo e(__('Doctor')); ?> : <?php echo e($data['doctor']['name']); ?></h5>
    ...
    <!-- Payments Details -->
    <?php if(isset($data['show_payments'])): ?>
        <table class="table table-bordered" width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td align="center"><?php echo e(date('d-m-Y',strtotime($payment['date']))); ?></td>
              <td align="center"><?php echo e(formated_price($payment['amount'])); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </tbody>
        </table>
...
<?php echo $__env->make('layouts.pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\extreme-vet\resources\views/pdf/doctor_report.blade.php ENDPATH**/ ?>