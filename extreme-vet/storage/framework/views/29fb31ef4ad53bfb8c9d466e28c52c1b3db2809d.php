...
<link rel="stylesheet" type="text/css" href="<?php echo e(url('plugins/datatables-fixedheader/css/fixedHeader.bootstrap4.min.css')); ?>">
<!-- toastr css -->
<link rel="stylesheet" href="<?php echo e(URL::asset('css/toastr.min.css')); ?>">
<!-- select2 css -->
<link rel="stylesheet" href="<?php echo e(url('css/select2.css')); ?>" type="text/css">
<!-- jquery ui -->
<link rel="stylesheet" href="<?php echo e(url('plugins/jquery-ui/jquery-ui.min.css')); ?>">
<!-- sweetalert -->
<link rel="stylesheet" href="<?php echo e(url('plugins/sweet-alert/sweetalert.css')); ?>">
<!-- RTL -->
<?php if(session('rtl')): ?>
    <link rel="stylesheet" href="<?php echo e(url('css/rtl.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('css/bootstrap-rtl.min.css')); ?>">
<?php endif; ?>

<?php echo $__env->yieldContent('css'); ?>
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/veterinaria/extreme-vet/resources/views/partials/head.blade.php ENDPATH**/ ?>