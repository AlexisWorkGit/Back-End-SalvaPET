...
<head>
    ...
    <style>
        ...
        .title{
            color:{{$reports_settings['owner_title']['color']}}!important;
            font-size:{{$reports_settings['owner_title']['font-size']}}!important;
            font-family:{{$reports_settings['owner_title']['font-family']}}!important;
        }
        .data{
            color:{{$reports_settings['owner_data']['color']}}!important;
            font-size:{{$reports_settings['owner_data']['font-size']}}!important;
            font-family:{{$reports_settings['owner_data']['font-family']}}!important;
        }
        .signature{
                    ...
                    <tbody>
                        <tr>
                            <td width="15%" align="left">
                                <img src="data:image/png;base64,{{$info_settings['reports_logo']}}" height="100px"/>
                            </td>
                            ...
                            <td align="right" width="15%">
                                @if(isset($group['animal']['owner']))
                                    <img src="https://chart.googleapis.com/chart?chs=120x120&cht=qr&chl={{url('owner/login/'.$group['animal']['owner']['code'])}}&choe=UTF-8" title="Link to Google.com" />
                                @endif
                            </td>
                        </tr>
            ...
            @if(isset($group['animal']))
                <table width="100%" class="table table-bordered pdf-header">
                    <tbody>
                        <tr>
                            <td width="50%">
                                <span class="title">{{__('Animal Code')}} :</span> <span
                                    class="data">
                                    @if(isset($group['animal']))
                                        {{ $group['animal']['code'] }}
                                    @endif
                            ...
                            <td width="50%">
                                <span class="title">{{__('Animal Name')}} :</span> <span
                                    class="data">
                                    @if(isset($group['animal']))
                                        {{ $group['animal']['name'] }}
                                    @endif
                        ...
                        <tr>
                            <td width="50%">
                                <span class="title">{{__('Owner Code')}} :</span> <span
                                    class="data">
                                    @if(isset($group['animal'])&&isset($group['animal']['owner']))
                                        {{ $group['animal']['owner']['code'] }}
                                    @endif
                                </span>

                            </td>
                            <td width="50%">
                                <span class="title">{{__('Owner Name')}} :</span> <span
                                    class="data">
                                    @if(isset($group['animal'])&&isset($group['animal']['owner']))
                                        {{ $group['animal']['owner']['name'] }}
                                    @endif
                                </span>
                            </td>
                        </tr>
