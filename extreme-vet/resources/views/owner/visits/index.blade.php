...
<div class="card card-primary">
    ...
    <form action="{{route('owner.visits.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <!-- /.card-header -->
        <div class="card-body">
            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="gender" placeholder="{{__('Gender')}}" id="gender" disabled required>
                                            ...
                                            <option value="male" @if($owner['gender']=='male') selected @endif>{{__('Male')}}</option>
                                            <option value="female" @if($owner['gender']=='female') selected @endif>{{__('Female')}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control datepicker" id="dob" placeholder="{{__('Date Of Birth')}}" name="dob" value="{{$owner['dob']}}" disabled readonly required>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script src="{{url('js/owner/visits.js')}}"></script>
@endsection