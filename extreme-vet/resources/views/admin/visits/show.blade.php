            ...
            <div class="col-lg-4">
               <div class="form-group">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" @if(isset($visit['animal'])) value="{{$visit['animal']['name']}}" @endif disabled>
                </div>
               </div>
            </div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" @if(isset($visit['animal'])) value="{{$visit['animal']['gender']}}" @endif class="form-control" disabled>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" @if(isset($visit['animal'])) value="{{$visit['animal']['dob']}}" @endif disabled>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" @if(isset($visit['animal'])&&isset($visit['animal']['owner']))  value="{{$visit['animal']['owner']['name']}}" @endif disabled>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" @if(isset($visit['animal'])&&isset($visit['animal']['owner']))  value="{{$visit['animal']['owner']['phone']}}" @endif disabled>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" @if(isset($visit['animal'])&&isset($visit['animal']['owner'])) value="{{$visit['animal']['owner']['email']}}" @endif disabled>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control"  id="address" @if(isset($visit['animal'])&&isset($visit['animal']['owner'])) value="{{$visit['animal']['owner']['address']}}" @endif disabled>
                        </div>
                    </div>
                </div>
            </div>
