                                      ...
                                      <div class="card-body">
                                          <div class="tab-content" id="custom-tabs-one-tabContent">
                                            <div class="tab-pane fade show active" id="owner_code" role="tabpanel" aria-labelledby="owner_code_tab">
                                              <div class="row">
                                                <div class="form-group">
                                                  <input name="owner_code[active]" type="checkbox" @if(!empty($emails_settings['owner_code'])&&$emails_settings['owner_code']['active']) checked @endif netliva-switch data-active-text="{{__('Active')}}" data-passive-text=" {{__('Deactive')}}"/>
                                                </div>
                                              </div>
                                              <div class="row">
                                                <p class="text-danger">{{__('Do not change variables')}}:<br>{owner_code} <br> {owner_name}</p>
                                              </div>
                                              <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label for="owner_code_subject">{{__('subject')}}</label>
                                                        <input type="text" id="owner_code_subject" class="form-control" name="owner_code[subject]" value="{{$emails_settings['owner_code']['subject']}}" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label for="owner_code_body">{{__('Body')}}</label>
                                                        <textarea class="form-control summernote" name="owner_code[body]" id="owner_code_body" cols="30" rows="10" required>{{$emails_settings['owner_code']['body']}}</textarea>
                                                    </div>
                                                </div>
                                            </div>                  
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="receipt" role="tabpanel" aria-labelledby="receipt">
                                              ...
                                              <div class="row">
                                                <p class="text-danger">{{__('Do not change variables')}}:<br>{owner_name}</p>
                                              </div>
                                              <div class="row">
                                                  <div class="col-lg-12">
                                                      <div class="form-group">
                                    ...
                                    <div class="card card-primary">
                                      ...
                                      <div class="card-body">
                                        <div class="row">
                                          <div class="col-lg-4">
                                            <div class="form-group">
                                              <label for="owner_title_color">{{__('Color')}}</label>
                                              <div class="input-group">
                                                  <input id="owner_title_color" type="text" class="form-control color_input" name="owner_title[color]" value="{{$reports_settings['owner_title']['color']}}" required>
                                                  <div class="input-group-append color_tool">
                                                      <span class="input-group-text"><i class="fas fa-square" style="color: {{$reports_settings['owner_title']['color']}}"></i></span>
                                                  </div>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="col-lg-4">
                                            <label for="owner_title_font_family">{{__('Font type')}}</label>
                                          ...
                                          <div class="col-lg-4">
                                            <label for="owner_title_font_size">{{__('Font size')}}</label>
                                            <input type="number" class="form-control" name="owner_title[font-size]" id="owner_title_font_size" min="1" value="{{$reports_settings['owner_title']['font-size']}}" required>
                                          </div>
                                    ...
                                    <div class="card card-primary">
                                      ...
                                      <div class="card-body">
                                        <div class="row">
                                          <div class="col-lg-4">
                                            <div class="form-group">
                                              <label for="owner_data_color">{{__('Color')}}</label>
                                              <div class="input-group">
                                                  <input id="owner_data_color" type="text" class="form-control color_input" name="owner_data[color]" value="{{$reports_settings['owner_data']['color']}}" required>
                                                  <div class="input-group-append color_tool">
                                                      <span class="input-group-text"><i class="fas fa-square" style="color: {{$reports_settings['owner_data']['color']}}"></i></span>
                                                  </div>
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="col-lg-4">
                                            <label for="owner_data_font_family">{{__('Font type')}}</label>
                                          ...
                                          <div class="col-lg-4">
                                            <label for="owner_data_font_size">{{__('Font size')}}</label>
                                            <input type="number" class="form-control" name="owner_data[font-size]" id="owner_data_font_size" min="1" value="{{$reports_settings['owner_data']['font-size']}}" required>
                                          </div>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content" id="custom-tabs-one-tabContent">
                                          <div class="tab-pane fade show active" id="sms_owner_code_tab" role="tabpanel" aria-labelledby="owner_code_tab">
                                              <div class="row">
                                                <div class="form-group">
                                                  <input name="owner_code[active]" type="checkbox" @if($sms_settings['owner_code']['active']) checked @endif netliva-switch data-active-text="{{__('Active')}}" data-passive-text=" {{__('Deactive')}}"/>
                                                </div>
                                              </div>
                                              <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <p class="text-danger">{{__('Do not change variables')}}:<br>{owner_name}<br> {owner_code}</p>
                                                        <label for="sms_owner_code_body">{{__('Message')}}</label>
                                                        <textarea class="form-control" name="owner_code[message]" id="sms_owner_code_body" cols="30" rows="3" required>{{$sms_settings['owner_code']['message']}}</textarea>
                                                    </div>
                                                </div>
                                            </div>                  
                                          </div>
                                      ...
                                      <div class="tab-content" id="custom-tabs-one-tabContent">
                                        <div class="tab-pane fade show active" id="whatsapp_receipt_tab" role="tabpanel" aria-labelledby="whatsapp_receipt_tab">
                                            ...
                                            <div class="row">
                                              <div class="col-lg-12">
                                                  <div class="form-group">
                                                      <p class="text-danger">{{__('Do not change variables')}}:<br>{owner_name}<br> {receipt_link}</p>
                                        ...
                                        <div class="tab-pane fade show" id="whatsapp_report_tab" role="tabpanel" aria-labelledby="whatsapp_report_tab">
                                          ...
                                          <div class="row">
                                              <div class="col-lg-12">
                                                  <div class="form-group">
                                                      <p class="text-danger">{{__('Do not change variables')}}: <br>{owner_name} <br> {report_link}</p>
                      ...
                      <div class="card card-primary">
                          ...
                          <form action="{{route('admin.settings.api_keys_submit')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control" id="google_map" name="google_map" placeholder="{{__('Google map key')}}" value="{{$api_keys_settings['google_map']}}" required>
                                </div>
                            </div>
                            <div class="card-footer">
                              <button type="submit" class="btn btn-primary"> <i class="fa fa-check"></i> {{__('Save')}}</button>
...
@section('scripts')
    ...
    <script>
      $(document).ready(function(){
        ...
        $('#owner_title_font_family').val('{{$reports_settings["owner_title"]["font-family"]}}');
        $('#owner_data_font_family').val('{{$reports_settings["owner_data"]["font-family"]}}');
