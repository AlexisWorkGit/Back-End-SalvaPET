        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="input-group mb-3">
                    ...
                    @if(isset($visit))
                        <input type="hidden" value="{{$visit['animal']['id']}}" animal_name="{{$visit['animal']['name']}}" id="visit_animal_id">
                    @endif
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <select id="code" name="animal_id" class="form-control" required>
                        @if(isset($group)&&isset($group['animal']))
                            <option value="{{$group['animal']['id']}}" selected>{{$group['animal']['code']}}</option>
                        @endif
                    </select>
                </div> 
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <select id="name" name="animal_id" class="form-control" required>
                        @if(isset($group)&&isset($group['animal']))
                            <option value="{{$group['animal']['id']}}" selected>{{$group['animal']['name']}}</option>
                        @endif
                    </select>
                </div> 
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <input class="form-control" id="gender" @if(isset($group)&&isset($group['animal'])) value="{{$group['animal']['gender']}}" @endif readonly>
                </div> 
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>{{__('Date of birth')}}</label>
                    <input class="form-control" id="dob" @if(isset($group)&&isset($group['animal'])) value="{{$group['animal']['dob']}}" @endif readonly>
                </div> 
            </div>
            <div class="col-lg-3">
                <div class="form-group">
                    <label>{{__('Owner name')}}</label>
                    <input class="form-control" id="owner_name" @if(isset($group)&&isset($group['animal'])) value="{{$group['animal']['owner']['name']}}" @endif  readonly>
                </div> 
            </div>
