                                ...
                                <th colspan="3">
                                    <table width="100%" class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <span class="page_title">{{__('Animal code')}} :</span> <span
                                                        class="data">@if(isset($group['animal']))
                                                        {{$group['animal']['code']}} @endif</span>
                                                </td>
                                                <td>
                                                    <span class="page_title">{{__('Animal name')}} :</span> <span
                                                        class="data"> @if(isset($group['animal']))
                                                        {{$group['animal']['name']}} @endif</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span class="page_title">{{__('Owner code')}} :</span> <span
                                                        class="data">@if(isset($group['animal'])&&isset($group['animal']['owner']))
                                                        {{$group['animal']['owner']['code']}} @endif</span>
                                                </td>
                                                <td>
                                                    <span class="page_title">{{__('Owner name')}} :</span> <span
                                                        class="data"> @if(isset($group['animal'])&&isset($group['animal']['owner']))
                                                        {{$group['animal']['owner']['name']}} @endif</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span class="page_title">{{__('Age')}} :</span> <span
                                                        class="data">@if(isset($group['animal']))
                                                        {{$group['animal']['age']}} @endif</span>

                                                </td>
                                                <td>
                                                    <span class="page_title">{{__('Gender')}} :</span> <span
                                                        class="data">@if(isset($group['animal']))
                                                        {{$group['animal']['gender']}} @endif</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
        ...
        <div class="row no-print">
            <div class="col-12">
                ...
                @if($whatsapp['receipt']['active']&&isset($group['receipt_pdf']))
                    ...
                    @endphp
                    <a target="_blank" href="https://wa.me/{{$group['animal']['owner']['phone']}}?text={{$message}}" class="btn btn-success">
