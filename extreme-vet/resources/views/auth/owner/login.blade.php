...
<form action="{{route('owner.auth.login_submit')}}" method="post" class="validate-form">
    ...
    <div class="wrap-input100 validate-input @if($errors->has('code')) error-validation @endif">
        ...
        <span class="label-input100">{{__('Owner Code')}}</span>
    </div>
    ...
    <div class="flex-sb-m w-full p-t-3 p-b-32">
        ...
        <div>
            <a href="{{route('owner.auth.mail')}}" class="txt1">
                {{__('Forgot Code ?')}}
            </a>
        </div>
    </div>
    ...
    <span class="login100-form-title mt-10">
        ...
        <a href="{{route('owner.auth.register')}}">
